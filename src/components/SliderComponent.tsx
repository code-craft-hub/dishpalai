      ...
      <>
        ...
        >
          {whyChooseUs.map(({ title, des }, index) => (
            <SwiperSlide
              className="!flex bg-gradient-to-t from-[#fe9545] via-white to-white p-4 md:p-8 lg:px-12 md:!w-[350px] !h-[350px] !border-[1px] !border-[#fe9545] rounded-3xl !items-center !justify-center"
              key={index}
            >
