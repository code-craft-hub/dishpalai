              ...
              <Tabs defaultValue="Month" className="">
                ...
                >
                  {planCard.map((item, key) => (
                    <div
                      key={key}
                      className={`${key == 1 ? "bg-buttonGreen" : key == 2 ? "bg-buttonYellow" : "bg-white"} p-4 md:p-8`}
                    >
                      ...
                      <div className="">
                        <span
                          className={`${key == 0 ? "text-black " : "text-white"} font-monst font-semibold text-2xl md:text-5xl`}
                        >
                          {formatCurrencyNormal(item.price || 0)}
                        </span>
                        <span
                          className={`${key == 0 ? "text-black " : "text-white"} font-monst`}
                        >
                          /per month
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between font-syne ">
                        ...
                        <Checkbox
                          className={` ${key == 1 ? "data-[state=checked]:text-green-500" : key == 2 ? "data-[state=checked]:text-yellow-500" : "data-[state=checked]:text-black"} data-[state=checked]:bg-white border-none size-5`}
                          id="terms"
                          checked
                        />
                      </div>
                      ...
                      <div className="flex justify-between font-syne ">
                        ...
                        {key == 0 ? (
                          ...
                          <Checkbox
                            className={` ${key == 1 ? "data-[state=checked]:text-green-500" : key == 2 && "data-[state=checked]:text-yellow-500"} data-[state=checked]:bg-white border-none size-5`}
                            id="terms"
                      ...
                      <div className="flex justify-between font-syne ">
                        ...
                        <p className="text-nowrap ml-4">
                          {key == 2 ? (
                            <Checkbox
                              id="terms"
                              className={` ${key === 2 && "data-[state=checked]:text-yellow-500"} data-[state=checked]:bg-white border-none size-5`}
                              checked
                            />
                          ) : (
                            item.notification
