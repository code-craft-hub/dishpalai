...
const SignUpPage = () => {
  ...
  return (
    <div className="h-full min-h-screen bg-bg3xl bg-cover grid md:grid-cols-2 gap-4 md:gap-8 max-2xl:p-8 ">
      ...
      <div className="flex items-center justify-center md:justify-start 2xl:mx-auto w-full max-w-lg">
        <div className="space-y-6 w-full">
          ...
          <div className="space-y-6">
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center space-x-3 space-y-0 py-4">
                        ...
                        <div className="space-x-1 leading-none">
                          ...
                          <FormLabel className="font-syne text-vividOrange hover:underline hover:cursor-pointer">
                            Terms & Condition
                          </FormLabel>
                        </div>
                      </FormItem>
            ...
            <div className="flex gap-6 items-center justify-center overflow-hidden">
              ...
              <div className="font-syne text-nowrap">Or Register With</div>
              <Separator className="bg-black w-full" />
            </div>
            <div
              onClick={() => {
